...
PermissionRoutes.put("/status_edit",authorize, PermissionControllerObj.edit_status);
PermissionRoutes .delete("/delete",authorize, PermissionControllerObj.deleteData);
